...
public class Weapon : Item
{
    ...
    public CardAbility Enchantment { get; set; } = CardAbility.None;

    public Weapon() { }
    public Weapon(string name, int damage, int price) : base(name, $"+{damage} DMG", price, ItemType.Weapon)
    {
        DamageBonus = damage;
    }
    ...
    {
        return Enchantment != CardAbility.None ? $"{Name} [{Enchantment}]" : Name;
    }
}
